...
public class StandardBoard implements Board {
    ...
    private void initWidth() {
        try {
            width = Launcher.getGameCfg().getIntegerValueOf("maxBoardWidth");
    ...
    private void initHeight() {
        try {
            height = Launcher.getGameCfg().getIntegerValueOf("maxBoardHeight");
        } catch (NotExistingVariableException e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
     ...
     */
    private void initMinGroupSize() {
        try {
            minGroupSize = Launcher.getGameCfg().getIntegerValueOf("minItemsInRow");
        } catch (NotExistingVariableException e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
